...
import { formatLocation, roleLabel, sourceLabel, userDisplayName } from './user-display'

const ALL = 'all'

type SortBy = 'lastLogin' | 'loginCount' | 'createdAt'
...
export function UsersPage() {
  ...
  }, [page, role, includeDeleted, sortBy, sortOrder])
            ...
            {users.length === 0 ? (
              ...
              users.map((u) => (
                <TableRow key={u.id}>
                  ...
                  <TableCell>{u.loginCount ?? 0}</TableCell>
                  <TableCell>
                    <Button
                      size='sm'
                      variant='ghost'
