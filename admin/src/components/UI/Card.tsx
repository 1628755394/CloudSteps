...
const Card = ({ 
  ...
  const variantClasses = {
    ...
    outlined: 'bg-transparent border-2 border-slate-200 dark:border-slate-800 shadow-none hover:shadow-md',
    elevated: 'bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-lg',
    filled: 'bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700',
