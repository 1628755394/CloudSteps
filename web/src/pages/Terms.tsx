...
export default function Terms() {
  return (
    <div className="min-h-dvh flex flex-col bg-background">
      <PageBackHeader title="用户协议" subtitle="生效日期：2026-03-26" fallbackTo="/settings" />
      <div className="flex-1 max-w-3xl w-full mx-auto px-4 py-5">
        <div className="rounded-xl border border-border bg-card p-5 space-y-5 text-charcoal leading-relaxed text-sm">
          ...
          <section className="space-y-2">
            <h2 className="text-foreground font-semibold text-base">1. 账户与使用资格</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-foreground font-semibold text-base">2. 服务内容</h2>
            <p className="text-muted-foreground">
          ...
          <section className="space-y-2">
            <h2 className="text-foreground font-semibold text-base">3. 用户行为规范</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-foreground font-semibold text-base">4. 知识产权</h2>
            <p className="text-muted-foreground">
          ...
          <section className="space-y-2">
            <h2 className="text-foreground font-semibold text-base">5. 免责声明</h2>
            <p className="text-muted-foreground">
          ...
          <section className="space-y-2">
            <h2 className="text-foreground font-semibold text-base">6. 协议变更与终止</h2>
            <p className="text-muted-foreground">
          ...
          <section className="space-y-2">
            <h2 className="text-foreground font-semibold text-base">7. 争议解决</h2>
            <p className="text-muted-foreground">
