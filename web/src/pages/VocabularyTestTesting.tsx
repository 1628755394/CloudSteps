...
export default function VocabularyTestTesting() {
  ...
  return (
    <div className="h-dvh w-full min-w-0 flex flex-col bg-[#F7F9FC] overflow-hidden">
      ...
      <main className="flex-1 min-h-0 w-full min-w-0 overflow-y-auto overflow-x-hidden flex flex-col px-4 py-3 max-w-4xl mx-auto">
        <div className="shrink-0 flex items-center gap-2 mb-3 max-w-3xl mx-auto w-full min-w-0">
        ...
        {showWarning && !busy && (
          <p className="shrink-0 text-center text-[11px] text-amber-600 mb-2 max-w-3xl mx-auto w-full min-w-0">
            超过 8 秒，建议选「不认识」
          </p>
        )}

        <div className="shrink-0 w-full max-w-3xl min-w-0 mx-auto bg-white rounded-2xl px-4 sm:px-6 py-6 mb-3 text-center shadow-sm border border-[#E2E8F0]/80">
        ...
        <div className="flex-1 min-h-0 flex flex-col justify-center gap-2 py-1 max-w-3xl mx-auto w-full min-w-0">
      ...
      <footer className="shrink-0 bg-white border-t border-[#E2E8F0] py-2.5 px-4">
        <div className="flex items-center justify-around max-w-3xl mx-auto w-full min-w-0">
