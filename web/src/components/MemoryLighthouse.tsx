...
const STAGE_DEFS: StageDef[] = [
  { num: "01", en: "First", stageKey: "memory.stage.unlearned", color: "#F45448", textColor: "#fff", kind: "unlearned", keyNode: true },
  { num: "02", en: "Second", stageKey: "memory.stage.review_2", color: "#F77C2E", textColor: "#fff", kind: "box", boxIndex: 0 },
  { num: "03", en: "Third", stageKey: "memory.stage.review_3", color: "#FCAA22", textColor: "#fff", kind: "box", boxIndex: 1 },
  { num: "04", en: "Fourth", stageKey: "memory.stage.review_4", color: "#FCD046", textColor: "#fff", kind: "box", boxIndex: 2 },
  { num: "05", en: "Fifth", stageKey: "memory.stage.review_5", color: "#FCE79B", textColor: "#fff", kind: "box", boxIndex: 3 },
  { num: "06", en: "Sixth", stageKey: "memory.stage.review_6", color: "#A7D45C", textColor: "#fff", kind: "box", boxIndex: 4 },
  { num: "07", en: "Seventh", stageKey: "memory.stage.review_7", color: "#28B864", textColor: "#fff", kind: "box", boxIndex: 5 },
  { num: "08", en: "Eighth", stageKey: "memory.stage.review_8", color: "#147C48", textColor: "#fff", kind: "box", boxIndex: 6 },
  { num: "09", en: "Ninth", stageKey: "memory.stage.mastered", color: "#17B3A6", textColor: "#fff", kind: "mastered", keyNode: true },
];
...
export function MemoryLighthouse({ data, onBlockClick }: MemoryLighthouseProps) {
  ...
  const rawData = useMemo(
    ...
    [stages, boxes, unlearnedCount, masteredCount]
  );
      ...
      return {
        ...
        tooltip: {
          ...
          formatter: (params: any) => {
            ...
            return `${params.name}<br/>${t("memory.tooltip_count", { count: realVal })}`;
          },
        },
        series: [
          {
  ...
  }, [buildOption, onBlockClick, rawData, stages]);
  ...
  const legendGroups = useMemo(
    () => [
      { label: t("memory.legend.unlearned"), chips: [{ color: stages[0].color }] },
      { label: t("memory.legend.review"), chips: stages.slice(1, 8).map((s) => ({ color: s.color })) },
      { label: t("memory.legend.mastered"), chips: [{ color: stages[8].color }] },
    ],
    [stages, t]
  );
      ...
      <div
        ...
        >
          ...
          >
            ...
            <div className="font-semibold text-[#2D3748] mt-1" style={{ fontSize: isMobile ? 11 : 14 }}>{t("memory.grid_title")}</div>
