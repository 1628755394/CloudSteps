    ...
    <aside className="fixed top-4 bottom-20 z-50" style={{ [sidePos]: 12, width, height, minWidth: 360, minHeight: 400 }}>
      <div className="relative h-full w-full rounded-2xl bg-[#8c582b] p-3 shadow-2xl">
        <div className="flex h-full w-full flex-col overflow-hidden rounded-xl border-4 border-[#70431f] bg-[#175b37]">
          ...
          {toolbarVisible && <div className="mx-2 mt-2 flex shrink-0 flex-wrap items-center gap-1 rounded-md bg-transparent px-0 py-1 text-white">
