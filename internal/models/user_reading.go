...
const (
	UserReadingStatusActive   = "active"
	UserReadingStatusArchived = "archived"

	UserReadingSourceManual = "manual"
	UserReadingSourceText   = "text"
	UserReadingSourceExcel  = "excel"
)
...
func (UserReadingPassage) TableName() string { return constants.TABLE_USER_READING_PASSAGES }

// UserReadingQuestion 用户自定义阅读理解题目
type UserReadingQuestion struct {
	common.BaseModel
...
func (UserReadingQuestion) TableName() string { return constants.TABLE_USER_READING_QUESTIONS }

// UserReadingRecord 用户自定义阅读答题记录
type UserReadingRecord struct {
	common.BaseModel
...
func (UserReadingRecord) TableName() string { return constants.TABLE_USER_READING_RECORDS }
